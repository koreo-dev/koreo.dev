  ...
  const whenToChoose = (
    <>
      ...
      <ul>
        ...
        <li>Cluster-scoped resources are okay and/or managed infrastructure can live in the same cloud project/account as the control plane</li>
      </ul>
      ...
      <ul>
        ...
        <li>You need resources to be namespaced rather than cluster-scoped and/or you want managed infrastructure to live in cloud projects/accounts separate from where the control plane lives (e.g. in a multi-tenant environment)</li>
      </ul>
      <br />
    </>
  );
